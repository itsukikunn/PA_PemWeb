                                ...
                                <form method="POST" class="quantity-form" style="display: inline-flex; align-items: center;">
                                    ...
                                    <div class="jumlah-item">
                                        <input type="number" name="quantity"
                                            value="<?php echo $item['jumlah_transaksi']; ?>"
                                            min="1" max="99" readonly style="width: 30px; text-align: center;">
                                    </div>
                                    <button type="button" class="tombol-aksi tambah" onclick="updateJumlah(this, 1)">+</button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; ?>
