...
if (isset($_POST["tambah_keranjang"])) {
    ...
    // Jika Stok Buku Kosong
    $query = "SELECT stok_buku FROM buku WHERE id_buku = $id_buku";
    $result = mysqli_query($conn, $query);
    ...
    if ($row['stok_buku'] <= 0) {
        ...
        window.location.href='detail_buku.php?id_buku=$id_buku';
        </script>";
    } else {
...
<body>
    ...
    <section class="detail-buku">
        ...
        <div class="detail-container">
            ...
            <button class="detail-button selengkapnya">Baca Selengkapnya</button>
            ...
            <form action="" method="POST" style="margin-top: 1.5rem;">
                ...
                <button class="detail-button" name="tambah_keranjang" type="submit">+ Keranjang</button>
            </form>
        </div>
    </section>
        ...
        <section class="buku-lainnya">
            ...
            <div class="buku-container">
                <?php foreach ($buku_acak as $buku) : ?>
                    <!-- Hidden form -->
                    <a href="detail_buku.php?id_buku=<?php echo $buku["id_buku"]; ?>">
                        <button class="detail-button tombol-rekomendasi" name="tombol-rekomendasi" type="submit">
                            <div class="buku-card">
