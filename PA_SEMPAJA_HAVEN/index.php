...
<?php require "navbar.php"; ?>
    ...
    <div class="banner-item large">
        <img id="bannerLarge" src="uploads/banner.png" alt="Banner Large">
        <span>HavenMedia</span>
    </div>
    <div class="banner-item small">
        <a href="detail_buku.php?id_buku=17">
            <img src="uploads/ban3.png" alt="Banner Small 1">
        </a>
    </div>
    <div class="banner-item small">
        <a href="detail_buku.php?id_buku=7">
            <img src="uploads/ban4.png" alt="Banner Small 2">
        </a>
    </div>
    </div>
    ...
    <section class="book-container">
        <div class="container">
            ...
            <div class="content">
                <div class="category-background">
                    <img src="uploads/rekomendasi.png" alt="Banner rekomendasi buku">
                </div>
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="category-background">
                    <img src="uploads/adaptasi-film.png" alt="Banner buku adaptasi film">
                </div>
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="category-background">
                    <img src="uploads/penulis-terkenal.png" alt="Banner penulis terkenal">
                </div>
